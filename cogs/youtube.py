...
class YouTube(commands.Cog):
    ...
    @commands.command(name="lookup", help="Look up the most recent 50 videos of a channel; Usage: !search [channel name]")
    async def lookup(self, ctx, channel_name: Optional[str]):
        """ 
        ...
        if channel_name is None:
            embed = discord.Embed(
                title="Usage",
                description="!lookup [channel name]",
